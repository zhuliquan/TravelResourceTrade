...
public class Generator {
	public Generator() {}
	public static ArrayList<Genetic> createPopulation(int populationNumber,int geneticType){
	...
	public static void main(String[] args) {
		...
		ArrayList<Genetic> group = createPopulation(100,Genetic.typeByRandom);
